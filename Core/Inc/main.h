...
#define Motor_Front_IN1_Pin GPIO_PIN_6
#define Motor_Front_IN1_GPIO_Port GPIOC
#define Motor_Front_IN2_Pin GPIO_PIN_7
#define Motor_Front_IN2_GPIO_Port GPIOC
#define Motor_Right_IN1_Pin GPIO_PIN_7
#define Motor_Right_IN1_GPIO_Port GPIOB
#define Motor_Right_IN2_Pin GPIO_PIN_8
